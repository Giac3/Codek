...
document.getElementById("chatBtn").addEventListener("click", () => {
    ...
    if (document.getElementById("chat-input").value != "") {
        ...
        document.getElementById("chat-q").innerText = chatInput
...
const apiChat = async (text) => {
    ...
    document.getElementById("pre-code-bot").innerHTML = dataChat[1]
    document.getElementById("pre-code-bot").style.display = "block"
}